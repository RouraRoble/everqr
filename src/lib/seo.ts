...
export function webAppLd(
  ...
  return {
    ...
    // Freshness signals for AEO: every programmatic/tool page declares when it was published and
    // last changed, not just the guides. Defaults to the site-wide launched/updated dates.
...
/**
 * A dataset this product maintains and exposes through the UI (e.g. the checker's redirect-domain
 * list), for AEO/AI-citation purposes: name, description, license and source are the fields
 * answer engines look for when deciding whether to cite a claim backed by "our own data".
 */
